...
public class SuscribeEmail_Module {
	public static void main(String[] args) throws IOException, InterruptedException {
		System.setProperty("webdriver.chrome.driver","/Users/abhinavsaini/eclipse-workspace/Ecommerce_WEB/TEST_CASES/DRIVER/chromedriver_105");
		 ...
		 driver.findElement(By.xpath("//*[@id=\"form\"]/div/input")).sendKeys("dongarwarrevati@gmail.com");
		 driver.findElement(By.xpath("//*[@id=\"form\"]/div/button")).click();
		 Thread.sleep(1000);
		 driver.quit();
